...
const { data: doc } = await useAsyncData(
  "about",
  () => queryCollection("about").path(`/about/${localeCode.value}`).first(),
  { watch: [localeCode] },
);
