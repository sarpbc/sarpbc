...
[![PR Checks](https://github.com/sarpbc/sarpbc/actions/workflows/pr.yml/badge.svg)](https://github.com/sarpbc/sarpbc/actions/workflows/pr.yml)

Open-source Rocket League news and data platform for fans who want a clear, healthy place to follow the competitive scene.

**Live site:** [sarpbc.org](https://sarpbc.org)

## Contributing

We welcome pull requests. Read [CONTRIBUTING.md](CONTRIBUTING.md) for setup, PR checks, and monorepo routing.

**New here?** Pick a [good first issue](https://github.com/sarpbc/sarpbc/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
...
App-specific notes: [apps/front/README.md](apps/front/README.md), [apps/back/README.md](apps/back/README.md).
...
Production deploys use **Dokploy**, not GitHub Actions image builds. On each push to `main`, [`release-tag.yml`](.github/workflows/release-tag.yml) creates a tag `vYYYY.MM.DD.N` (for example `v2026.06.03.42`) and a GitHub Release with notes from [CHANGELOG.md](CHANGELOG.md). Configure Dokploy apps with trigger **On Tag**.
...
- [MCP server (staff AI tools)](docs/MCP.md)
- [License](LICENSE) · [NOTICE](NOTICE)
- [GitHub contributors](https://github.com/sarpbc/sarpbc/graphs/contributors)
